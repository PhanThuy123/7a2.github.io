...
document.addEventListener("DOMContentLoaded", function () {
    // Danh sách bài học
    const lessons = [
        { title: "Bài 1: Nguyên tử", content: '<a href="https://gamma.app/docs/Nguyen-Tu-Kham-Pha-The-Gioi-Vi-Mo-wvk51nardvm0nkg" target="_blank">Xem bài giảng</a>', video: "https://youtu.be/n0YpIEsnVBI?si=nRvJcDWNN7IQxXfn" },
        { title: "Bài 2: Nguyên tố hóa học", content: '<a href="https://gamma.app/docs/Bai-2-Nguyen-To-Hoa-Hoc-xz1dia5gmm94yeu" target="_blank">Xem bài giảng</a>', video: "https://youtu.be/tyBO3kLLu5o?si=-IcpVDDA5iSgq4np" },
        { title: "Bài 3: Sơ lược về bảng tuần hoàn các nguyên tố hóa học", content: '<a href="https://gamma.app/docs/So-Luoc-Ve-Bang-Tuan-Hoan-9tu2ddfnx3teltd" target="_blank">Xem bài giảng</a>', video: "https://youtu.be/BiFKWYI-daA?si=Ss579n3_YJ7BjQ1o" },
        ...
        { title: "Bài 5: Giới thiệu về liên kết hóa học", content: '<a href="https://gamma.app/docs/Gioi-Thieu-Ve-Lien-Ket-Hoa-Hoc-xb96jcyiyjnjtgt" target="_blank"> Xem bài giảng</a>', video: "https://youtu.be/eEvOJCXxX2c?si=juSsjgojOgHN-SZe" },
        { title: "Bài 6: Sóng âm", content: '<a href="https://gamma.app/docs/BAI-6-SONG-AM-g2i4jlv74e80wmx" target="_blank"> Xem bài giảng</a>', video: "https://youtu.be/c8YLd9zx5LY?si=RjZWL6YeU-3LfWnV" },
